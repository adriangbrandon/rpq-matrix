...
public:
    ...
    ring_rpq_v3(vector<spo_triple>& D, bool verbose = true)
    {
        uint64_t i, pos_c;
...
typedef ring_rpq_v3<std::stack<interval_state_type>> ring_rpq_dfs;
typedef ring_rpq_v3<std::queue<interval_state_type>> ring_rpq_bfs;
