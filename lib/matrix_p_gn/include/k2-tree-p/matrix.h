...
#ifndef INCLUDEDmatrixp
#define INCLUDEDmatrixp
...
matrix matXor1 (uint64_t row, matrix A, matrix B, uint64_t col);
        ...
        // (boolean) intersection, assumed to be of the same logside
